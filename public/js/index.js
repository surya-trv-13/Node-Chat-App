...
socket.on('newEmail',function(e){ // This is for listening event emitted from the server in the client side
  console.log('Email is' , e); // here ES6 features doesn't work so do basic syntax
});

socket.on('newMessage',function(newM) {
  console.log('Message is ',newM)
});
